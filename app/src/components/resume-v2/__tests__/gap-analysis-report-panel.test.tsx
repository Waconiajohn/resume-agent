...
describe('GapAnalysisReportPanel', () => {
  ...
  it('falls back to shared coaching policy when no explicit interview questions are present', () => {
    const ga = makeGapAnalysis({
      requirements: [
        {
          requirement: 'Cloud Infrastructure',
    ...
    expect(screen.getByText(/where you used AWS together with Azure or GCP/i)).toBeTruthy();
