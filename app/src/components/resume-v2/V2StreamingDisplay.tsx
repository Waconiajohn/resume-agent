                ...
                <div className="rounded-xl border border-[var(--badge-red-text)]/28 bg-[var(--badge-red-bg)] px-4 py-3 text-sm text-[var(--badge-red-text)]/90" role="alert">
                  ...
                  {onRetryPipeline && (
                    <button
                      ...
                      className="mt-3 rounded-lg border border-[var(--badge-red-text)]/30 bg-[var(--surface-3)] px-4 py-2 text-sm font-medium text-[var(--badge-red-text)] transition-colors hover:bg-[var(--badge-red-bg)]"
                    >
                      Retry Pipeline
                    </button>
                  )}
