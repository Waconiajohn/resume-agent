    ...
    <div className="room-shell animate-[card-enter_500ms_ease-out_forwards] opacity-0 space-y-5">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="eyebrow-label">Benchmark signal</p>
          <h3 className="mt-2 text-sm font-semibold text-white/90">The Benchmark</h3>
        </div>
        <span className="rounded-md border border-white/[0.08] bg-white/[0.03] px-2.5 py-1 text-[10px] uppercase tracking-[0.16em] text-white/42">What the hiring manager pictures</span>
      </div>
      ...
      {data.expected_achievements.length > 0 && (
        <div>
          <h4 className="mb-2 text-xs font-medium text-white/60 uppercase tracking-[0.16em]">Expected Achievements</h4>
      ...
      {data.differentiators.length > 0 && (
        <div>
          <h4 className="mb-2 text-xs font-medium text-white/60 uppercase tracking-[0.16em]">What Sets the Best Apart</h4>
