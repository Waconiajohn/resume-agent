        ...
        <GlassCard className="p-4">
          <div className="flex items-start justify-between gap-4 mb-3">
            <div className="min-w-0">
              ...
              <p className="text-sm text-[var(--text-muted)] mt-1">
                Monitor whether reveal-screen retry is being used and whether it actually recovers achievement proof creation.
              </p>
            </div>
            <div className="text-right shrink-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="rounded-[8px] border border-[var(--line-soft)] bg-[var(--accent-muted)]/40 px-3 py-2.5">
              ...
              <p className="text-xs text-[var(--text-soft)]">Achievement proof recovered</p>
            </div>
            <div className="rounded-[8px] border border-[var(--line-soft)] bg-[var(--accent-muted)]/40 px-3 py-2.5">
