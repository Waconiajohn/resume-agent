...
describe('AdminDashboard', () => {
  ...
  it('surfaces profile-setup retry recovery in the funnel tab', async () => {
    ...
    expect(screen.getByText('Monitor whether reveal-screen retry is being used and whether it actually recovers achievement proof creation.')).toBeInTheDocument();
