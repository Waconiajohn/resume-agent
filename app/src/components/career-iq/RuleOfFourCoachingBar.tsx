  ...
  return (
    <GlassCard className="p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[12px] font-medium text-[var(--badge-amber-text)]/80">
            ...
            <div className="flex gap-1.5 flex-wrap">
              {group.missingRoles.map((role) => (
                <button
                  ...
                  className={cn(
                    'text-[12px] text-[var(--link)]/70 bg-[var(--link)]/[0.06] px-2 py-0.5 rounded-full',
                    'hover:bg-[var(--link)]/[0.12] transition-colors flex items-center gap-1',
                  )}
                >
