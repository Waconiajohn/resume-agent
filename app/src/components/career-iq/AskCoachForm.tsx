...
const URGENCY_CONFIG: Record<CoachUrgency, { label: string; activeClass: string }> = {
  ...
  high: {
    label: 'High',
    activeClass: 'bg-[var(--badge-red-bg)] text-[var(--badge-red-text)] border-[var(--badge-red-text)]/20',
  },
};
  ...
  return (
    <GlassCard className="p-5">
      ...
      <div className="space-y-3">
        ...
        {/* Error */}
        {error && (
          <div className="text-[12px] text-[var(--badge-red-text)] bg-[var(--badge-red-bg)] border border-[var(--badge-red-text)]/20 rounded-lg px-3 py-2">
            {error}
          </div>
        )}
