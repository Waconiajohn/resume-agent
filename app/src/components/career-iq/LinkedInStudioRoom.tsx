...
import type { SavedCalendarReportFull, StructuredPost } from '@/hooks/useContentCalendar';
...
function SeriesPlanner({ posts, onWritePost }: { posts: StructuredPost[]; onWritePost: () => void }) {
  if (posts.length === 0) {
    return (
      <div className="flex flex-col gap-3">
  ...
  // Group posts by content type for the series view
