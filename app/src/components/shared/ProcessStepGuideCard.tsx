    ...
    <GlassCard className={`border-l-2 ${toneBorderClass(tone)} p-3.5 ${className}`.trim()}>
      ...
      {!compact && (
        <div className="mt-2.5 grid gap-3 sm:grid-cols-2">
          <div>
            <div className="text-[11px] uppercase tracking-[0.12em] text-white/45">System does</div>
            <div className="mt-1 text-xs leading-relaxed text-white/72">{contract.systemDoes}</div>
          </div>
          <div>
            <div className="text-[11px] uppercase tracking-[0.12em] text-white/45">You do</div>
