...
export function GlassSkeleton({ className }: { className?: string }) {
  return <div className={cn('rounded-lg bg-[var(--accent-muted)] motion-safe:animate-pulse', className)} />;
}

export function GlassSkeletonCard({ lines = 3, className }: { lines?: number; className?: string }) {
  return (
    <div className={cn('rounded-xl border border-[var(--line-soft)] bg-[var(--accent-muted)] p-4 space-y-3', className)}>
