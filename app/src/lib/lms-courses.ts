...
**The fix is simpler than you think.** It's not about gaming the system — it's about speaking the language of the job description you're targeting.`,
    slots: [
      ...
      },
      {
        ...
        agentSource: 'resume-v2',
        dataPath: 'assembly.final_resume',
        format: 'list',
      },
    ],
    linkedAgent: 'resume',
    ...
    slots: [
      {
        ...
        agentSource: 'resume-v2',
        dataPath: 'assembly.hiring_manager_scan.red_flags',
        format: 'list',
      },
    ],
    linkedAgent: 'resume',
...
Get these four right and every other piece of your job search gets easier.`,
    slots: [
      ...
      },
      {
        ...
        agentSource: 'resume-v2',
        dataPath: 'assembly.final_resume.header.branded_title',
        format: 'text',
      },
      {
        key: 'why_me_concise',
    ...
    slots: [
      {
        ...
        agentSource: 'resume-v2',
        dataPath: 'assembly.hiring_manager_scan.scan_score',
        format: 'score-badge',
      },
    ],
    linkedAgent: 'resume',
