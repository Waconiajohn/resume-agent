  ...
  try {
    ...
    const output = {
      ...
      env: {
        ...
        MAX_CREATE_SESSION_BODY_BYTES: env.MAX_CREATE_SESSION_BODY_BYTES ?? null,
        MAX_MESSAGE_BODY_BYTES: env.MAX_MESSAGE_BODY_BYTES ?? null,
        MAX_PIPELINE_START_BODY_BYTES: env.MAX_PIPELINE_START_BODY_BYTES ?? null,
        MAX_PIPELINE_RESPOND_BODY_BYTES: env.MAX_PIPELINE_RESPOND_BODY_BYTES ?? null,
        MAX_SECTION_CONTEXT_EVIDENCE_ITEMS: env.MAX_SECTION_CONTEXT_EVIDENCE_ITEMS ?? null,
        MAX_SECTION_CONTEXT_KEYWORDS: env.MAX_SECTION_CONTEXT_KEYWORDS ?? null,
        MAX_SECTION_CONTEXT_GAPS: env.MAX_SECTION_CONTEXT_GAPS ?? null,
        MAX_SECTION_CONTEXT_ORDER_ITEMS: env.MAX_SECTION_CONTEXT_ORDER_ITEMS ?? null,
        MAX_SECTION_CONTEXT_TEXT_CHARS: env.MAX_SECTION_CONTEXT_TEXT_CHARS ?? null,
        MAX_SECTION_CONTEXT_BLUEPRINT_BYTES: env.MAX_SECTION_CONTEXT_BLUEPRINT_BYTES ?? null,
