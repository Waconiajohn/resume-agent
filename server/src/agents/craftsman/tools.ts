...
const writeSectionTool: ResumeAgentTool = {
  ...
  description:
    ...
    'Always call self_review_section immediately after writing to verify quality.',
  model_tier: 'primary',
  input_schema: {
    type: 'object',
    properties: {
...
- **Narrative Coherence**: Does this section reinforce a consistent positioning angle? Does it read as part of a coherent professional identity, or could it describe a completely different person? If the section's tone, seniority level, or domain focus feels disconnected from its own content, flag it.`;
