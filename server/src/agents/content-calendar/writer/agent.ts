...
2. If any post has a weak hook (quality_score < 70), use craft_hook to rewrite it.
3. Use add_hashtags for any post that needs hashtag refinement.
...
Work through ALL posts systematically. Do not skip any day in the plan.`,
  tools: [
    ...writerTools,
