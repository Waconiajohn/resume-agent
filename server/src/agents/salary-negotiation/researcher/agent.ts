...
4. Call assess_total_comp (no input required) to synthesize all research into a total compensation assessment and emit the research_complete event

After calling all 4 tools, stop — the Negotiation Strategist agent will take over.
