...
- Parallel structure across ALL bullets (e.g., "Led X resulting in Y" repeated 15 times) — some parallelism is good writing, but perfect uniformity across an entire resume signals AI generation. NOTE: A dominant RAS (Result-Action-Situation) pattern is expected in quality resumes — only flag it if EVERY bullet follows the identical opener pattern with no variation in sentence structure, length, or framing.
- The "power verb + quantified result + method" triple appearing in every single bullet without exception: "Drove $12M revenue by implementing..." "Reduced costs 30% by streamlining..." "Increased retention 25% by redesigning..." — real resumes use this pattern in MOST bullets but break it occasionally with narrative bullets, context-setting bullets, or scope-defining bullets. A resume with 80% structured bullets and 20% varied is authentic, not AI-generated.
