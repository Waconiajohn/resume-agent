...
import { followUpEmailRoutes } from './routes/follow-up-email.js';
import { networkingMessageRoutes } from './routes/networking-message.js';
...
app.route('/api/follow-up-email', followUpEmailRoutes);
app.route('/api/networking-message', networkingMessageRoutes);
...
app.route('/api/auth/webhook', authWebhookRoutes);
