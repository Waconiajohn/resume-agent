...
function buildGroundedWorkflowExplanation(stage: string | null, pendingGate: string | null, pipelineStatus: string | null): string | null {
...
function buildGroundedWorkflowSuggestion(stage: string | null, pendingGate: string | null, pipelineStatus: string | null): string | null {
  if (pendingGate) {
