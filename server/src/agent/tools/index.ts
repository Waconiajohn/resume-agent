...
export const toolDefinitions: ToolDefinition[] = [
  ...
  },
  {
    ...
    input_schema: {
      type: 'object',
      properties: {
        section: { type: 'string', enum: ['summary', 'selected_accomplishments', 'experience', 'skills', 'education', 'certifications', 'title_adjustments'], description: 'Which resume section to generate' },
  ...
  },
  {
    ...
    input_schema: {
      type: 'object',
      properties: {
        section: { type: 'string', enum: ['summary', 'selected_accomplishments', 'experience', 'skills', 'education', 'certifications', 'title_adjustments'], description: 'Which resume section to propose edits for' },
        current_content: { type: 'string', description: 'The current content of this section' },
        requirements: { type: 'array', items: { type: 'string' }, description: 'Key requirements this section should address' },
