...
- `MAX_SECTION_CONTEXT_EVIDENCE_ITEMS`, `MAX_SECTION_CONTEXT_KEYWORDS`, `MAX_SECTION_CONTEXT_GAPS`
- `MAX_SECTION_CONTEXT_ORDER_ITEMS`, `MAX_SECTION_CONTEXT_TEXT_CHARS`, `MAX_SECTION_CONTEXT_BLUEPRINT_BYTES`
